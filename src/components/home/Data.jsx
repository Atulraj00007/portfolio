...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Atul Raj
                <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <p className="home__description">As a CSE Engineer from Jamshedpur, I am dedicated to leveraging my technical skills and problem-solving abilities to
            contribute effectively to innovative projects and achieve continuous professional growth within the
            field.</p>
